...
add("LC11", 10, "visual_projection"); add("LC15", 10, "visual_projection"); add("LC18", 10, "visual_projection"); add("LC21", 10, "visual_projection"); add("L3", 20, "ol_intrinsic"); add("L5", 20, "ol_intrinsic"); add("DNg02_a", 3, "descending_neuron"); add("DNg02_b", 3, "descending_neuron"); add("SApp10", 30, "vnc_sensory"); add("SApp02", 20, "vnc_sensory"); add("DLMn c-f", 8, "vnc_motor"); add("b1 MN", 2, "vnc_motor"); add("IN19B043", 20, "vnc_intrinsic"); add("Pm3", 6, "ol_intrinsic"); add("Mi1", 20, "ol_intrinsic"); add("Tm2", 10, "ol_intrinsic")
